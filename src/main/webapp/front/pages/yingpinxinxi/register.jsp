      ...
      <div class="form-inner">
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="zhiweimingcheng" name="zhiweimingcheng" placeholder="请输入职位名称" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="zhiweifenlei" name="zhiweifenlei" placeholder="请输入职位分类" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="zhiweixinxi" name="zhiweixinxi" placeholder="请输入职位信息" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
